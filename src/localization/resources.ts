...
export const english = {
  ...
  'result.hints': 'Hints',
  'result.quickPencilsUsed': 'Quick pencils',
...
const japanese: TranslationResource = {
  ...
  'result.mistakes': 'ミス',
  'result.hints': 'ヒント',
  'result.quickPencilsUsed': 'クイックメモ',
  ...
  'result.openReplay': '今回のプレイを振り返る',
  'result.returnHome': 'ホームに戻る',
...
const german: TranslationResource = {
  ...
  'result.quickPencilsUsed': 'Schnellnotizen',
  ...
  'result.openReplay': 'Diese Runde ansehen',
  'result.returnHome': 'Zur Startseite',
...
const simplifiedChinese: TranslationResource = {
  ...
  'result.openReplay': '查看本局复盘',
  'result.returnHome': '返回首页',
