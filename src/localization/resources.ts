...
export const english = {
  ...
  'premium.benefitStartingInventory':
    'Both assistance balances filled to 99 on first purchase',
  ...
  'statistics.totalTime': 'Play time',
  'statistics.activity': 'Activity',
  'statistics.hintsUsed': 'Smart hints',
  'statistics.quickPencilsUsed': 'Quick pencils',
  ...
  'result.supply.quickPencil': 'Quick pencil',
  'result.supply.smartHint': 'Smart hint',
  'result.supply.collect': 'Collect',
  'result.supply.credited': '+{{count}}',
  'result.supply.balance': 'Balance {{count}}',
  'result.supply.full': 'Full',
  'result.supply.limitReached':
    'The actual refill was limited by the inventory cap.',
  'result.supply.fullBody':
    'Inventory is full, so this puzzle’s refill did not increase either balance.',
...
const japanese: TranslationResource = {
  ...
  'settings.debugCredits': 'デバッグ用クレジットを999にする',
  'settings.debugCreditBalance':
  ...
  'statistics.totalTime': 'プレイ時間',
  'statistics.activity': 'プレイ記録',
  'statistics.hintsUsed': 'スマートヒント',
  'statistics.quickPencilsUsed': 'クイックメモ',
  ...
  'result.supply.quickPencil': 'クイックメモ',
  'result.supply.smartHint': 'スマートヒント',
  'result.supply.collect': '受け取る',
  'result.supply.credited': '+{{count}}',
  'result.supply.balance': '残り{{count}}',
  'result.supply.full': '上限',
  'result.supply.limitReached': '実際の補充量は所持上限までになりました。',
  'result.supply.fullBody':
    '所持数が上限のため、今回はどちらも増えませんでした。',
...
const german: TranslationResource = {
  ...
  'settings.debugCredits': 'Testguthaben auf 999 setzen',
  'settings.debugCreditBalance':
  ...
  'premium.benefitStartingInventory':
    'Beide Hilfsguthaben beim ersten Kauf auf 99 auffüllen',
  'premium.benefitCompletionRewards':
  ...
  'statistics.totalTime': 'Spielzeit',
  'statistics.activity': 'Aktivität',
  'statistics.hintsUsed': 'Hinweise',
  'statistics.quickPencilsUsed': 'Schnellnotizen',
  ...
  'result.supply.quickPencil': 'Schnellnotiz',
  'result.supply.smartHint': 'Intelligenter Hinweis',
  'result.supply.collect': 'Einsammeln',
  'result.supply.credited': '+{{count}}',
  'result.supply.balance': 'Bestand {{count}}',
  'result.supply.full': 'Voll',
  'result.supply.limitReached':
    'Die tatsächliche Auffüllung wurde durch das Bestandslimit begrenzt.',
  'result.supply.fullBody':
    'Der Bestand ist voll, daher hat diese Auffüllung keinen Wert erhöht.',
...
const simplifiedChinese: TranslationResource = {
  ...
  'settings.debugCredits': '将调试额度补充到 999',
  'settings.debugCreditBalance': '智能提示：{{hints}} · 快速铅笔：{{pencils}}',
  'home.premium': 'Premium',
  ...
  'premium.benefitStartingInventory': '首次购买，两种辅助额度各补足到 99',
  'premium.benefitCompletionRewards': '首次完成每道题，可继续获得辅助额度',
  ...
  'statistics.totalTime': '游戏时间',
  'statistics.activity': '活动',
  'statistics.hintsUsed': '智能提示',
  'statistics.quickPencilsUsed': '快速铅笔',
  ...
  'result.supply.quickPencil': '快速铅笔',
  'result.supply.smartHint': '智能提示',
  'result.supply.collect': '收下',
  'result.supply.credited': '+{{count}}',
  'result.supply.balance': '当前 {{count}}',
  'result.supply.full': '已满',
  'result.supply.limitReached': '实际补给已按库存上限结算。',
  'result.supply.fullBody': '库存已满，本局补给未增加。',
