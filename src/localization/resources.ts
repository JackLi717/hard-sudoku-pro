...
export const english = {
  ...
  'modal.replace.body':
    'Starting a new puzzle will mark this game as abandoned, and it cannot be restored.',
  ...
  'home.completed': '{{count}} solved',
  'home.solved': 'Solved',
  'home.attempts': 'Attempts',
  'home.hints': 'Hints',
  'home.settings': 'Settings',
  'home.developmentOnly': 'DEVELOPMENT ONLY',
  'settings.hintLab': 'Hint Lab · 40 Techniques',
  ...
  'settings.completionPreview': 'Completion screen preview',
  'settings.multiSelectOnboardingPreview': 'Multi-select tutorial preview',
  'settings.debugCredits': 'Set debug credits to 999',
  'settings.debugCreditBalance':
    'Smart hints: {{hints}} · Quick Candidates: {{pencils}}',
  ...
  'credits.balance': '{{count}} uses available',
  ...
  'credits.rewardSuccess': 'One available use was added.',
  'credits.dismissed':
    'No reward was received, so the available uses did not change.',
  'credits.failed':
    'The ad did not complete. The available uses did not change.',
  'credits.watching': 'Opening ad…',
  'credits.watch': 'Watch ad · +1',
  'credits.retry': 'Check again',
  'credits.footnote':
    'Closing, skipping, losing connection or declining the ad never blocks the puzzle or reduces your available uses.',
  ...
  'trust.privacyLocalBody':
    'Puzzles, progress, settings, available assistance uses and Premium status are stored locally. No app account is required.',
  ...
  'settings.rewardQuickNotes': 'Quick Candidates',
  ...
  'home.levelDescription1': 'Basic techniques',
  'home.levelDescription2': 'Candidate logic',
  'home.levelDescription3': 'Combined techniques',
  'home.levelDescription4': 'Advanced techniques',
  'home.levelDescription5': 'Deep reasoning',
  'statistics.title': 'Statistics',
  'statistics.attempts': 'Games started',
  ...
  'statistics.hintsUsed': 'Smart hints',
  'statistics.quickPencilsUsed': 'Quick Candidates',
  'statistics.byLevel': 'By difficulty',
  ...
  'help.tutorial.footnote':
    'Tutorial actions do not affect saved games, statistics or available uses.',
  ...
  'help.tutorial.step.select':
    'Each row, column and 3×3 box must contain 1–9 with no repeats. Tap the highlighted empty cell.',
  ...
  'help.tutorial.step.pencilOn':
    'When you are unsure, use candidate notes. Tap Notes.',
  ...
  'help.tutorial.step.pencilOff':
    'Only 7 remains. Tap Notes again to return to digit entry.',
  ...
  'techniques.subtitle':
    'Explore all 40 logical techniques used by the hint engine, grouped by level.',
  ...
  'settings.highlightCandidateNotesHint':
    'In Notes mode, highlight notes matching the selected digit.',
  ...
  'game.boardHidden': 'Your board is hidden while paused.',
  'game.continue': 'Continue game',
  'game.abandon': 'Abandon game',
  'game.enterDigit': 'Enter {{digit}}, {{count}} remaining',
  'game.undo': 'Undo',
  'game.erase': 'Erase',
  'game.quick': 'Quick Candidates',
  'game.pencil': 'Notes',
  'game.multiSelectTitle': 'Multi-select',
  'game.multiSelectCountOne': '1 cell selected',
  'game.multiSelectCount': '{{count}} cells selected',
  'game.multiSelectDone': 'Done',
  'game.removeCandidateFromSelected':
    'Remove candidate {{digit}} from selected cells',
  'game.multiSelectOnboarding':
    'Tap other cells to select them.\nTap a number to remove that candidate.\nTap Done to finish.',
  'game.multiSelectGotIt': 'Got it',
  'game.multiSelectDismiss': 'Close multi-select tutorial',
  'game.hint': 'Hint',
  'game.active': 'on',
  ...
  'replay.pencilOn': 'Notes on',
  'replay.pencilOff': 'Notes off',
  'replay.sourceQuick': 'Switch to Quick Candidates',
  'replay.sourceManual': 'Switch to candidate notes',
  'replay.event.generate_quick_draft':
    'Quick Candidates generated / regenerated',
  ...
  'replay.listHintOne': '{{count}} hint',
  'replay.listHints': '{{count}} hints',
  ...
  'replay.initialBoard': 'Initial board',
  ...
  'message.quick_draft_missing': 'Generate Quick Candidates first.',
  ...
  'message.insufficient_quick_pencil_credits':
    'No Quick Candidates uses remain.',
  'message.insufficient_smart_hint_credits': 'No Smart Hint uses remain.',
...
const japanese: TranslationResource = {
  ...
  'modal.replace.body':
    '新しい問題を始めると、このゲームは中断として記録され、元に戻せません。',
  ...
  'settings.hintLab': 'ヒントラボ · 40テクニック',
  'home.statistics': '統計',
  'home.help': '遊び方',
  ...
  'settings.developerTools': '開発テスト',
  'settings.completionPreview': '完了画面プレビュー',
  'settings.multiSelectOnboardingPreview': '複数マス選択の案内をプレビュー',
  'settings.debugCredits': 'デバッグ用の残り回数を999にする',
  'settings.debugCreditBalance':
    'スマートヒント: {{hints}} · クイック候補: {{pencils}}',
  'home.premium': 'Premium',
  ...
  'credits.balance': 'あと{{count}}回利用できます',
  ...
  'credits.dismissed': '報酬を受け取らなかったため、残り回数は変わりません。',
  'credits.failed': '広告を完了できませんでした。残り回数は変わりません。',
  ...
  'settings.rewardQuickNotes': 'クイック候補',
  ...
  'home.quickCandidates': 'クイック候補',
  'home.availableCount': 'あと {{count}} 回',
  'home.closeLevelPicker': 'レベル選択を閉じる',
  'home.chooseLevelSubtitle': '練習したい論理の難しさを選んでください。',
  'home.levelDescription1': '基本テクニック',
  'home.levelDescription2': '候補の論理',
  'home.levelDescription3': '複合テクニック',
  'home.levelDescription4': '高度なテクニック',
  'home.levelDescription5': '高度な論理推論',
  'statistics.title': '統計',
  'statistics.attempts': '開始回数',
  'statistics.completions': 'クリア',
  'statistics.completionRate': 'クリア率',
  'statistics.failures': 'ミスで終了',
  'statistics.abandonments': '中断',
  'statistics.totalTime': '総プレイ時間',
  'statistics.activity': 'プレイ記録',
  'statistics.hintsUsed': 'スマートヒント',
  'statistics.quickPencilsUsed': 'クイック候補',
  'statistics.byLevel': '難易度別',
  'help.title': '遊び方',
  ...
  'help.tutorial.footnote':
    'チュートリアルの操作は、保存したゲーム、統計、補助機能の残り回数に影響しません。',
  'help.tutorial.progress': '{{current}} / {{total}}',
  ...
  'help.tutorial.step.pencilOff':
    '7だけが残りました。もう一度「メモ」をタップして数字入力に戻ります。',
  ...
  'help.tutorial.complete.startLevel': 'かんたんを始める',
  'help.tutorial.complete.home': 'ホームに戻る',
  'techniques.title': '数独テクニック',
  'techniques.subtitle':
    'ヒントエンジンが使う40種類の論理テクニックをレベル別に確認できます。',
  ...
  'game.paused': '一時停止中',
  'game.boardHidden': '一時停止中は盤面が隠れます。',
  ...
  'game.quick': 'クイック候補',
  'game.pencil': 'メモ',
  'game.multiSelectTitle': '複数マス選択',
  'game.multiSelectCountOne': '1マスを選択中',
  'game.multiSelectCount': '{{count}}マスを選択中',
  'game.multiSelectDone': '完了',
  'game.removeCandidateFromSelected': '選択したマスから候補{{digit}}を削除',
  'game.multiSelectOnboarding':
    'ほかのマスをタップして選択します。\n数字をタップして候補を削除します。\n完了をタップして終了します。',
  'game.multiSelectGotIt': 'わかりました',
  'game.multiSelectDismiss': '複数マス選択の案内を閉じる',
  'game.hint': 'ヒント',
  'game.active': 'オン',
  ...
  'replay.sourceQuick': 'クイック候補に切り替え',
  'replay.sourceManual': '候補メモに切り替え',
  'replay.event.generate_quick_draft': 'クイック候補を生成／再生成',
  ...
  'replay.listHintOne': 'ヒント{{count}}回',
  'replay.listHints': 'ヒント{{count}}回',
  ...
  'message.quick_draft_missing': '先にクイック候補を生成してください。',
...
const german: TranslationResource = {
  ...
  'modal.replace.body':
    'Wenn du ein neues Rätsel startest, wird dieses Spiel als abgebrochen gespeichert und kann nicht wiederhergestellt werden.',
  ...
  'home.levelRange': 'Einfach–Extrem',
  'home.level': '{{level}}',
  'home.difficulty': '{{level}}',
  ...
  'settings.developerTools': 'Entwicklertools',
  'settings.completionPreview': 'Abschlussansicht testen',
  'settings.multiSelectOnboardingPreview': 'Mehrfachauswahl-Anleitung ansehen',
  'settings.debugCredits': 'Verfügbare Testnutzungen auf 999 setzen',
  'settings.debugCreditBalance':
    'Hinweise: {{hints}} · Schnellkandidaten: {{pencils}}',
  'home.premium': 'Premium',
  ...
  'credits.balance': '{{count}} Nutzungen verfügbar',
  ...
  'credits.rewardSuccess': 'Eine verfügbare Nutzung wurde hinzugefügt.',
  'credits.dismissed':
    'Keine Belohnung erhalten; die verfügbaren Nutzungen wurden nicht geändert.',
  'credits.failed':
    'Die Anzeige wurde nicht abgeschlossen. Die verfügbaren Nutzungen wurden nicht geändert.',
  'credits.watching': 'Anzeige wird geöffnet…',
  'credits.watch': 'Anzeige ansehen · +1',
  'credits.retry': 'Erneut prüfen',
  'credits.footnote':
    'Schließen, Überspringen, Verbindungsverlust oder Ablehnen blockiert nie das Rätsel und verringert keine vorhandenen Nutzungen.',
  'trust.privacyTitle': 'Datenschutz',
  'trust.supportTitle': 'Support',
  'trust.licensesTitle': 'Drittanbieter-Lizenzen',
  'trust.privacyLocalTitle': 'Daten auf diesem Gerät',
  'trust.privacyLocalBody':
    'Rätsel, Fortschritt, Einstellungen, verfügbare Hilfsnutzungen und Premium-Status werden lokal gespeichert. Ein App-Konto ist nicht erforderlich.',
  ...
  'settings.rewardQuickNotes': 'Schnellkandidaten',
  ...
  'home.quickCandidates': 'Schnellkandidaten',
  ...
  'home.levelDescription1': 'Grundtechniken',
  'home.levelDescription2': 'Kandidatenlogik',
  'home.levelDescription3': 'Kombinierte Techniken',
  'home.levelDescription4': 'Fortgeschrittene Techniken',
  'home.levelDescription5': 'Tiefgehende Logik',
  'statistics.title': 'Statistik',
  'statistics.attempts': 'Gestartete Spiele',
  ...
  'statistics.totalTime': 'Gesamtspielzeit',
  'statistics.activity': 'Aktivität',
  'statistics.hintsUsed': 'Hinweise',
  'statistics.quickPencilsUsed': 'Schnellkandidaten',
  'statistics.byLevel': 'Nach Schwierigkeit',
  ...
  'help.tutorial.footnote':
    'Tutorial-Aktionen beeinflussen weder Spiele noch Statistiken oder verfügbare Nutzungen.',
  'help.tutorial.progress': '{{current}} / {{total}}',
  ...
  'help.tutorial.step.pencilOn':
    'Wenn du unsicher bist, nutze Kandidatennotizen. Tippe auf Notizen.',
  ...
  'help.tutorial.step.pencilOff':
    'Nur 7 bleibt übrig. Tippe erneut auf Notizen, um eine Ziffer einzutragen.',
  ...
  'help.tutorial.complete.startLevel': 'Einfach starten',
  'help.tutorial.complete.home': 'Zurück zur Startseite',
  'techniques.title': 'Sudoku-Techniken',
  'techniques.subtitle':
    'Entdecke alle 40 logischen Techniken der Hinweis-Engine, nach Level gruppiert.',
  ...
  'game.boardHidden': 'Das Spielfeld ist während der Pause verdeckt.',
  'game.continue': 'Spiel fortsetzen',
  'game.abandon': 'Spiel aufgeben',
  'game.enterDigit': '{{digit}} eingeben, {{count}} verbleibend',
  'game.undo': 'Rückgängig',
  'game.erase': 'Löschen',
  'game.quick': 'Schnellkandidaten',
  'game.pencil': 'Notizen',
  'game.multiSelectTitle': 'Mehrfachauswahl',
  'game.multiSelectCountOne': '1 Feld ausgewählt',
  'game.multiSelectCount': '{{count}} Felder ausgewählt',
  'game.multiSelectDone': 'Fertig',
  'game.removeCandidateFromSelected':
    'Kandidat {{digit}} aus ausgewählten Feldern entfernen',
  'game.multiSelectOnboarding':
    'Weitere Felder antippen, um sie auszuwählen.\nEine Zahl antippen, um diesen Kandidaten zu entfernen.\nFertig antippen, um zu beenden.',
  'game.multiSelectGotIt': 'Verstanden',
  'game.multiSelectDismiss': 'Anleitung zur Mehrfachauswahl schließen',
  'game.hint': 'Hinweis',
  'game.active': 'ein',
  ...
  'replay.sourceQuick': 'Zu Schnellkandidaten wechseln',
  'replay.sourceManual': 'Zu Kandidatennotizen wechseln',
  'replay.event.generate_quick_draft': 'Schnellkandidaten erzeugt / erneuert',
  ...
  'replay.listHintOne': '{{count}} Hinweis',
  'replay.listHints': '{{count}} Hinweise',
  ...
  'replay.initialBoard': 'Startbrett',
  ...
  'message.quick_draft_missing': 'Erstelle zuerst Schnellkandidaten.',
  'message.incorrect_values':
  ...
  'message.insufficient_quick_pencil_credits':
    'Keine Schnellkandidaten-Nutzungen mehr verfügbar.',
  'message.insufficient_smart_hint_credits':
    'Keine Hinweis-Nutzungen mehr verfügbar.',
...
const simplifiedChinese: TranslationResource = {
  ...
  'modal.replace.body': '开始新题后，本局会记为“已放弃”，且无法恢复。',
  ...
  'settings.developerTools': '开发测试',
  'settings.completionPreview': '完成页预览',
  'settings.multiSelectOnboardingPreview': '预览多格选择引导',
  'settings.debugCredits': '将调试可用次数补充到 999',
  'settings.debugCreditBalance': '智能提示：{{hints}} · 快速候选：{{pencils}}',
  'home.premium': 'Premium',
  ...
  'credits.rewardSuccess': '已增加 1 次可用次数。',
  'credits.dismissed': '没有收到有效奖励，可用次数没有变化。',
  'credits.failed': '广告未能完成，可用次数没有变化。',
  'credits.watching': '正在打开广告…',
  'credits.watch': '观看广告 · +1',
  'credits.retry': '重新检查',
  'credits.footnote':
    '关闭、跳过、断网或拒绝广告都不会阻塞题目，也不会减少已有可用次数。',
  'trust.privacyTitle': '隐私',
  'trust.supportTitle': '支持',
  'trust.licensesTitle': '第三方许可',
  'trust.privacyLocalTitle': '本机数据',
  'trust.privacyLocalBody':
    '题目、进度、设置、辅助功能可用次数和 Premium 状态保存在本机，无需注册应用账号。',
  ...
  'settings.rewardQuickNotes': '快速候选',
  ...
  'home.levelDescription1': '基础技巧，轻松热身',
  'home.levelDescription2': '候选判断，稳步进阶',
  'home.levelDescription3': '综合技巧，更具挑战',
  'home.levelDescription4': '进阶技巧，复杂推理',
  'home.levelDescription5': '深度推理，极限挑战',
  'statistics.title': '统计',
  'statistics.attempts': '开局次数',
  'statistics.completions': '完成',
  'statistics.completionRate': '完成率',
  'statistics.failures': '错误超限',
  'statistics.abandonments': '放弃',
  'statistics.totalTime': '总游戏时长',
  'statistics.activity': '活动',
  'statistics.hintsUsed': '智能提示',
  'statistics.quickPencilsUsed': '快速候选',
  'statistics.byLevel': '按难度',
  'help.title': '玩法说明',
  'help.tutorial.eyebrow': '互动教学 · 约 3 分钟',
  'help.tutorial.completed': '已完成教学',
  'help.tutorial.title': '亲手完成棋盘，学会基本玩法',
  'help.tutorial.body':
    '跟随高亮的格和按钮逐步操作。教学使用与游戏中相同的棋盘和操作方式。',
  ...
  'techniques.goal.placement': '确定某个格中唯一必然成立的数字。',
  'techniques.goal.elimination':
  ...
  'settings.alternatingBoxShading': '3×3 宫交错底色',
  'settings.alternatingBoxShadingHint':
  ...
  'settings.highlightCandidateNotes': '高亮同数笔记',
  'settings.highlightCandidateNotesHint':
    '笔记模式下，高亮与当前数字相同的候选笔记。',
  'settings.outlineUniqueCandidateNotes': '标记唯一候选笔记',
  'settings.outlineUniqueCandidateNotesHint':
    '当前数字在某行、列或宫的候选笔记中仅出现一次时，为它加上轻描边。只依据你的笔记，不代表答案已确定。',
  'settings.oneTapFill': '轻点填入',
  'settings.oneTapFillHint':
    '仅在专家和极限难度中启用。点击行、列或宫的最后一个空格，或当前只显示一个候选数的格，即可填入数字。',
  ...
  'game.quick': '快速候选',
  'game.pencil': '笔记',
  'game.multiSelectTitle': '多格选择',
  'game.multiSelectCountOne': '已选 1 格',
  'game.multiSelectCount': '已选 {{count}} 格',
  'game.multiSelectDone': '完成',
  'game.removeCandidateFromSelected': '从选中格删除候选数 {{digit}}',
  'game.multiSelectOnboarding':
    '点其他格继续选择。\n点数字删除对应候选。\n点完成结束多格选择。',
  'game.multiSelectGotIt': '明白了',
  'game.multiSelectDismiss': '关闭多格选择教学',
  'game.hint': '提示',
  'game.active': '已开启',
  'game.remaining': '可用 {{count}} 次',
  'hint.smart': '智能提示',
  ...
  'replay.pencilOn': '笔记模式已开启',
  'replay.pencilOff': '笔记模式已关闭',
  'replay.sourceQuick': '切换到快速候选',
  'replay.sourceManual': '切换到候选笔记',
  'replay.event.generate_quick_draft': '生成／重新生成快速候选',
  ...
  'replay.listHintOne': '{{count}} 提示',
  'replay.listHints': '{{count}} 提示',
  ...
  'message.filled_cell': '编辑候选笔记前请先擦除已填数字。',
  'message.nothing_to_erase': '这个格没有可擦除的内容。',
  ...
  'message.insufficient_quick_pencil_credits': '快速候选的可用次数已用完。',
  'message.insufficient_smart_hint_credits': '智能提示的可用次数已用完。',
