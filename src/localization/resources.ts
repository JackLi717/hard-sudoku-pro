...
export const english = {
  ...
  'home.levelDescription1': 'Basic techniques, an easy warm-up',
  'home.levelDescription2': 'Candidate decisions, steady progress',
  'home.levelDescription3': 'Combined techniques, a greater challenge',
  'home.levelDescription4': 'Advanced techniques, complex reasoning',
  'home.levelDescription5': 'Deep reasoning, the ultimate challenge',
...
const japanese: TranslationResource = {
  ...
  'home.levelDescription1': '基本の技法で、気軽にウォームアップ',
  'home.levelDescription2': '候補を見極め、着実にステップアップ',
  'home.levelDescription3': '技法を組み合わせ、さらに挑戦',
  'home.levelDescription4': '高度な技法と複雑な推理',
  'home.levelDescription5': '深い推理で、限界に挑戦',
  'statistics.title': '統計',
...
const german: TranslationResource = {
  ...
  'home.levelDescription1': 'Grundtechniken zum entspannten Einstieg',
  'home.levelDescription2': 'Kandidaten prüfen, sicher vorankommen',
  'home.levelDescription3': 'Techniken kombinieren, mehr Herausforderung',
  'home.levelDescription4': 'Fortgeschrittene Techniken, komplexe Logik',
  'home.levelDescription5': 'Tiefe Logik, höchste Herausforderung',
