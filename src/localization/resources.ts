...
export const english = {
  ...
  'replay.noExplanation': 'No saved direct explanation for this action.',
...
const japanese: TranslationResource = {
  ...
  'replay.noExplanation': 'この操作には保存済みの直接説明がありません。',
...
const german: TranslationResource = {
  ...
  'replay.noExplanation':
    'Für diese Aktion ist keine direkte Erklärung gespeichert.',
...
const simplifiedChinese: TranslationResource = {
  ...
  'replay.noExplanation': '此操作没有已保存的直接解释。',
